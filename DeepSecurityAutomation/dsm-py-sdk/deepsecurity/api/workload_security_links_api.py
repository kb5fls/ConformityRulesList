...
class WorkloadSecurityLinksApi(object):
    ...
    def get_migration_information(self, workload_security_link_id, api_version, **kwargs):  # noqa: E501
        """Get migration information through the Workload Security Link  # noqa: E501

        Get migration information through the Workload Security Link.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_migration_information(workload_security_link_id, api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_migration_information_with_http_info(workload_security_link_id, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_migration_information_with_http_info(workload_security_link_id, api_version, **kwargs)  # noqa: E501
            return data

    def get_migration_information_with_http_info(self, workload_security_link_id, api_version, **kwargs):  # noqa: E501
        """Get migration information through the Workload Security Link  # noqa: E501

        Get migration information through the Workload Security Link.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_migration_information_with_http_info(workload_security_link_id, api_version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_migration_information" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workload_security_link_id' is set
        if ('workload_security_link_id' not in params or
                params['workload_security_link_id'] is None):
            raise ValueError("Missing the required parameter `workload_security_link_id` when calling `get_migration_information`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_migration_information`")  # noqa: E501

        if 'workload_security_link_id' in params and not re.search('\\d+', str(params['workload_security_link_id'])):  # noqa: E501
            raise ValueError("Invalid value for parameter `workload_security_link_id` when calling `get_migration_information`, must conform to the pattern `/\\d+/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='MigrationInformation',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
