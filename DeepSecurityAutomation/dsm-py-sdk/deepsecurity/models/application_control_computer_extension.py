...
class ApplicationControlComputerExtension(object):
    ...
    attribute_map = {
        ...
        'trust_ruleset_id': 'trustRulesetID',
    ...
    def __init__(self, state=None, module_status=None, block_unrecognized=None, ruleset_id=None, trust_ruleset_id=None, maintenance_mode_status=None, maintenance_mode_duration=None, maintenance_mode_start_time=None, maintenance_mode_end_time=None):  # noqa: E501
        ...
        if trust_ruleset_id is not None:
            self.trust_ruleset_id = trust_ruleset_id
    ...
    @property
    def trust_ruleset_id(self):
        """Gets the trust_ruleset_id of this ApplicationControlComputerExtension.  # noqa: E501

        ID of the trust ruleset. An empty string will set it to \"None\" and assigning a value of 0 will set it to \"Inherited\".  # noqa: E501

        :return: The trust_ruleset_id of this ApplicationControlComputerExtension.  # noqa: E501
        :rtype: str
        """
        return self._trust_ruleset_id

    @trust_ruleset_id.setter
    def trust_ruleset_id(self, trust_ruleset_id):
        """Sets the trust_ruleset_id of this ApplicationControlComputerExtension.

        ID of the trust ruleset. An empty string will set it to \"None\" and assigning a value of 0 will set it to \"Inherited\".  # noqa: E501

        :param trust_ruleset_id: The trust_ruleset_id of this ApplicationControlComputerExtension.  # noqa: E501
        :type: str
        """

        self._trust_ruleset_id = trust_ruleset_id
