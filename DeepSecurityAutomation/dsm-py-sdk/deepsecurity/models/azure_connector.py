...
class AzureConnector(object):
    ...
    swagger_types = {
        ...
        'azure_ad_application_certificate': 'str',
        'azure_ad_application_private_key': 'str',
        'azure_ad_application_private_key_secret': 'str',
        'azure_ad_application_certificate_expiration_date': 'int',
    ...
    attribute_map = {
        ...
        'azure_ad_application_certificate': 'azureAdApplicationCertificate',
        'azure_ad_application_private_key': 'azureAdApplicationPrivateKey',
        'azure_ad_application_private_key_secret': 'azureAdApplicationPrivateKeySecret',
        'azure_ad_application_certificate_expiration_date': 'azureAdApplicationCertificateExpirationDate',
    ...
    def __init__(self, name=None, azure_tenant_id=None, subscription_id=None, azure_ad_application_id=None, azure_ad_application_secret=None, azure_ad_application_certificate=None, azure_ad_application_private_key=None, azure_ad_application_private_key_secret=None, azure_ad_application_certificate_expiration_date=None, resource_api_end_point=None, login_api_end_point=None, last_sync_time=None, id=None):  # noqa: E501
        ...
        self._azure_ad_application_certificate = None
        self._azure_ad_application_private_key = None
        self._azure_ad_application_private_key_secret = None
        self._azure_ad_application_certificate_expiration_date = None
        ...
        if azure_ad_application_certificate is not None:
            self.azure_ad_application_certificate = azure_ad_application_certificate
        if azure_ad_application_private_key is not None:
            self.azure_ad_application_private_key = azure_ad_application_private_key
        if azure_ad_application_private_key_secret is not None:
            self.azure_ad_application_private_key_secret = azure_ad_application_private_key_secret
        if azure_ad_application_certificate_expiration_date is not None:
            self.azure_ad_application_certificate_expiration_date = azure_ad_application_certificate_expiration_date
    ...
    @property
    def azure_ad_application_certificate(self):
        """Gets the azure_ad_application_certificate of this AzureConnector.  # noqa: E501

        The Azure Active Directory Application certificate for authentication. The certificate should be in X.509 PEM format and encoded in Base64. Not present in returned objects.  # noqa: E501

        :return: The azure_ad_application_certificate of this AzureConnector.  # noqa: E501
        :rtype: str
        """
        return self._azure_ad_application_certificate

    @azure_ad_application_certificate.setter
    def azure_ad_application_certificate(self, azure_ad_application_certificate):
        """Sets the azure_ad_application_certificate of this AzureConnector.

        The Azure Active Directory Application certificate for authentication. The certificate should be in X.509 PEM format and encoded in Base64. Not present in returned objects.  # noqa: E501

        :param azure_ad_application_certificate: The azure_ad_application_certificate of this AzureConnector.  # noqa: E501
        :type: str
        """

        self._azure_ad_application_certificate = azure_ad_application_certificate

    @property
    def azure_ad_application_private_key(self):
        """Gets the azure_ad_application_private_key of this AzureConnector.  # noqa: E501

        The Azure Active Directory Application private key of azureAdApplicationCertificate. The private key should be in PEM format and encoded in Base64. Not present in returned objects.  # noqa: E501

        :return: The azure_ad_application_private_key of this AzureConnector.  # noqa: E501
        :rtype: str
        """
        return self._azure_ad_application_private_key

    @azure_ad_application_private_key.setter
    def azure_ad_application_private_key(self, azure_ad_application_private_key):
        """Sets the azure_ad_application_private_key of this AzureConnector.

        The Azure Active Directory Application private key of azureAdApplicationCertificate. The private key should be in PEM format and encoded in Base64. Not present in returned objects.  # noqa: E501

        :param azure_ad_application_private_key: The azure_ad_application_private_key of this AzureConnector.  # noqa: E501
        :type: str
        """

        self._azure_ad_application_private_key = azure_ad_application_private_key

    @property
    def azure_ad_application_private_key_secret(self):
        """Gets the azure_ad_application_private_key_secret of this AzureConnector.  # noqa: E501

        The optional secret of Azure Active Directory Application private key if the private key is protected with secret/password.  # noqa: E501

        :return: The azure_ad_application_private_key_secret of this AzureConnector.  # noqa: E501
        :rtype: str
        """
        return self._azure_ad_application_private_key_secret

    @azure_ad_application_private_key_secret.setter
    def azure_ad_application_private_key_secret(self, azure_ad_application_private_key_secret):
        """Sets the azure_ad_application_private_key_secret of this AzureConnector.

        The optional secret of Azure Active Directory Application private key if the private key is protected with secret/password.  # noqa: E501

        :param azure_ad_application_private_key_secret: The azure_ad_application_private_key_secret of this AzureConnector.  # noqa: E501
        :type: str
        """

        self._azure_ad_application_private_key_secret = azure_ad_application_private_key_secret

    @property
    def azure_ad_application_certificate_expiration_date(self):
        """Gets the azure_ad_application_certificate_expiration_date of this AzureConnector.  # noqa: E501

        Expiration timestamp of the the Azure Active Directory Application certificate, in milliseconds since epoch.  # noqa: E501

        :return: The azure_ad_application_certificate_expiration_date of this AzureConnector.  # noqa: E501
        :rtype: int
        """
        return self._azure_ad_application_certificate_expiration_date

    @azure_ad_application_certificate_expiration_date.setter
    def azure_ad_application_certificate_expiration_date(self, azure_ad_application_certificate_expiration_date):
        """Sets the azure_ad_application_certificate_expiration_date of this AzureConnector.

        Expiration timestamp of the the Azure Active Directory Application certificate, in milliseconds since epoch.  # noqa: E501

        :param azure_ad_application_certificate_expiration_date: The azure_ad_application_certificate_expiration_date of this AzureConnector.  # noqa: E501
        :type: int
        """

        self._azure_ad_application_certificate_expiration_date = azure_ad_application_certificate_expiration_date
