...
class ComputerMoveTasksApi(object):
    ...
    def create_batch_computer_move_task(self, batch_computer_move_task, api_version, **kwargs):  # noqa: E501
        """Create a Batch Computer Move Task  # noqa: E501

        Create a new batch computer move task.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_batch_computer_move_task(batch_computer_move_task, api_version, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BatchComputerMoveTask batch_computer_move_task: Tasks to move the computers. (required)
        :param str api_version: The version of the api being called. (required)
        :return: BatchComputerMoveTaskList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_batch_computer_move_task_with_http_info(batch_computer_move_task, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.create_batch_computer_move_task_with_http_info(batch_computer_move_task, api_version, **kwargs)  # noqa: E501
            return data

    def create_batch_computer_move_task_with_http_info(self, batch_computer_move_task, api_version, **kwargs):  # noqa: E501
        """Create a Batch Computer Move Task  # noqa: E501

        Create a new batch computer move task.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_batch_computer_move_task_with_http_info(batch_computer_move_task, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['batch_computer_move_task', 'api_version']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_batch_computer_move_task" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'batch_computer_move_task' is set
        if ('batch_computer_move_task' not in params or
                params['batch_computer_move_task'] is None):
            raise ValueError("Missing the required parameter `batch_computer_move_task` when calling `create_batch_computer_move_task`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `create_batch_computer_move_task`")  # noqa: E501
        ...
        body_params = None
        if 'batch_computer_move_task' in params:
            body_params = params['batch_computer_move_task']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='BatchComputerMoveTaskList',  # noqa: E501
    ...
    def list_computer_move_tasks(self, api_version, **kwargs):  # noqa: E501
        ...
        List all computer move tasks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
